...
| `cors_headers` | No | [access_schemas-cors_headers](access_schemas-cors_headers.md) |  |
| `custom_deny_message` | No | [access_custom_deny_message](access_custom_deny_message.md) |  |
| `custom_deny_url` | No | [access_schemas-custom_deny_url](access_schemas-custom_deny_url.md) |  |
| `domain` | Yes | [access_components-schemas-domain](access_components-schemas-domain.md) |  |
...
| `options_preflight_bypass` | No | [access_schemas-options_preflight_bypass](access_schemas-options_preflight_bypass.md) |  |
