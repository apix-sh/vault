...
| `jurisdiction` | No | string | The [jurisdiction](https://developers.cloudflare.com/r2/reference/data-location/#jurisdictional-restrictions) of the R2 bucket. Allowed values: eu, fedramp, fedramp-high |
