---
method: "POST"
url: "https://api.cloudflare.com/client/v4/accounts/{account_id}/ai/run/@cf/google/omni-embeddinggemma-300m"
...
| :--- | :---: | :--- | :--- |
| `text` | Yes | oneOf(2) | Input text to embed. Can be a single string or a list of strings. |
