---
method: "POST"
url: "https://api.cloudflare.com/client/v4/accounts/{account_id}/cloudforce-one/events/queries/create"
auth: "bearer"
...
| :--- | :---: | :--- | :--- |
| `alert_enabled` | Yes | boolean | Enable alerts for this query |
| `alert_rollup_enabled` | Yes | boolean | Enable alert rollup for this query |
| `name` | Yes | string | Unique name for the saved query |
| `query_json` | Yes | string | JSON string containing the query parameters |
| `rule_enabled` | Yes | boolean | Enable rule for this query |
