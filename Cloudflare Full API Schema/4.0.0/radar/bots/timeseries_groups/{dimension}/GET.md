---
method: "GET"
url: "https://api.cloudflare.com/client/v4/radar/bots/timeseries_groups/{dimension}"
...
| `bot` | No | array<string> | Filters results by bot name.<br/>*Serialization: style=Form* |
| `botOperator` | No | array<string> | Filters results by bot operator.<br/>*Serialization: style=Form* |
| `botCategory` | No | array<string> | Filters results by bot category.<br/>*Serialization: style=Form* |
| `botKind` | No | array<string> | Filters results by bot kind.<br/>*Serialization: style=Form* |
| `botVerificationStatus` | No | array<string> | Filters results by bot verification status (Verified vs. Unverified).<br/>*Serialization: style=Form* |
