---
method: "GET"
url: "https://api.cloudflare.com/client/v4/radar/ct/summary/{dimension}"
...
| :--- | :------: | :--- | :---------- |
| `dimension` | Yes | string | Specifies the certificate attribute by which to group the results.<br/>*Serialization: style=Simple* |
