---
method: "GET"
url: "https://api.cloudflare.com/client/v4/radar/http/timeseries_groups/{dimension}"
...
| :--- | :------: | :--- | :---------- |
| `dimension` | Yes | string | Specifies the HTTP attribute by which to group the results.<br/>*Serialization: style=Simple* |
