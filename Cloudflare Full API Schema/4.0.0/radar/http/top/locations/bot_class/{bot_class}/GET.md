---
method: "GET"
url: "https://api.cloudflare.com/client/v4/radar/http/top/locations/bot_class/{bot_class}"
...
| :--- | :------: | :--- | :---------- |
| `bot_class` | Yes | string | Bot class. Refer to [Bot classes](https://developers.cloudflare.com/radar/concepts/bot-classes/).<br/>*Serialization: style=Simple* |
