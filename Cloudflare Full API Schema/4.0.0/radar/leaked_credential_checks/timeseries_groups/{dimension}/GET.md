---
method: "GET"
url: "https://api.cloudflare.com/client/v4/radar/leaked_credential_checks/timeseries_groups/{dimension}"
...
| `compromised` | No | array<string> | Filters results by compromised credential status (clean vs. compromised).<br/>*Serialization: style=Form* |
| `checkResult` | No | array<string> | Filters results by leaked credential check result.<br/>*Serialization: style=Form* |
