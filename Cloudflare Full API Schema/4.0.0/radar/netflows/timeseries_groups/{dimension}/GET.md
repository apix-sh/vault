---
method: "GET"
url: "https://api.cloudflare.com/client/v4/radar/netflows/timeseries_groups/{dimension}"
...
| :--- | :------: | :--- | :---------- |
| `dimension` | Yes | string | Specifies the NetFlows attribute by which to group the results.<br/>*Serialization: style=Simple* |
...
| `product` | No | array<string> | Filters the results by network traffic product types.<br/>*Serialization: style=Form* |
