...
| `bucketSize` | No | integer | Specifies the width for every bucket in the histogram.<br/>*Serialization: style=Form* |
| `metricGroup` | No | string | Metrics to be returned.<br/>*Serialization: style=Form* |
