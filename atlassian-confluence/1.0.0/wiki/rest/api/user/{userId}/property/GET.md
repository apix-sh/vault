---
method: "GET"
url: "//your-domain.atlassian.net/wiki/rest/api/user/{userId}/property"
auth: "basic | oauth2"
...
| Name | Required | Type | Description |
| :--- | :------: | :--- | :---------- |
| `start` | No | integer | The starting index of the returned properties. |
| `limit` | No | integer | The maximum number of properties to return per page.<br/>Note, this may be restricted by fixed system limits. |
...
[UserPropertyKeyArray](../../../../../../_components/schemas/UserPropertyKeyArray.md)


### 400

Returned if request has malformed syntax or userId is not a valid user id.
