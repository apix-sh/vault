...
| :--- | :------: | :--- | :---------- |
| `schemeId` | Yes | string | The ID of the issue security scheme level belongs to. |
| `levelId` | Yes | string | The ID of the issue security level to update. |
...
[UpdateIssueSecurityLevelDetails](../../../../../../../_components/schemas/UpdateIssueSecurityLevelDetails.md)
