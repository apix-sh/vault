---
method: "DELETE"
url: "https://your-domain.atlassian.net/rest/api/3/notificationscheme/{notificationSchemeId}/notification/{notificationId}"
auth: "basic | oauth2"
...
| `notificationId` | Yes | string | The ID of the notification. |
