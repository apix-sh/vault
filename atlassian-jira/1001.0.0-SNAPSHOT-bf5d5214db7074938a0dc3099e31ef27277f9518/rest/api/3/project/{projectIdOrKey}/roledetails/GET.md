---
method: "GET"
url: "https://your-domain.atlassian.net/rest/api/3/project/{projectIdOrKey}/roledetails"
auth: "basic | oauth2"
...
| Name | Required | Type | Description |
| :--- | :------: | :--- | :---------- |
| `currentMember` | No | boolean | Whether the roles should be filtered to include only those the user is assigned to. |
| `excludeConnectAddons` | No | boolean |  |
| `excludeOtherServiceRoles` | No | boolean | Do not return the default JSM company-managed space from CSM spaces, or the default CSM roles from JSM spaces. |
...
array<[ProjectRoleDetails](../../../../../../_components/schemas/ProjectRoleDetails.md)>
