---
method: "GET"
url: "https://your-domain.atlassian.net/rest/api/3/universal_avatar/view/type/{type}/owner/{entityId}"
auth: "basic | oauth2"
...
| `entityId` | Yes | string | The ID of the project or issue type the avatar belongs to. |
