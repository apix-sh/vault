...
| `enabled` | No | array<string> | Used for configuring load_balancing_pool_enablement_alert |
| `environment` | No | array<string> | Used for configuring pages_event_alert |
| `event` | No | array<string> | Used for configuring pages_event_alert |
...
| `limit` | No | array<string> | Used for configuring billing_usage_alert |
...
| `product` | No | array<string> | Used for configuring billing_usage_alert |
| `project_id` | No | array<string> | Used for configuring pages_event_alert |
...
| `services` | No | array<string> | Used for configuring clickhouse_alert_fw_ent_anomaly |
| `slo` | No | array<string> | Usage depends on specific alert type |
| `status` | No | array<string> | Used for configuring health_check_status_notification |
...
| `traffic_exclusions` | No | array<string> | Used for configuring traffic_anomalies_alert |
