...
| `act` | No | any | Allowed values: abuse_phishing |
...
| `original_work` | No | string | Text not exceeding 255 characters. This field may be released by Cloudflare to third parties such as the Lumen Database (https://lumendatabase.org/).<br/> |
