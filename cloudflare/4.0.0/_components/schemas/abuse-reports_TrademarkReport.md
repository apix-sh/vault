...
| `act` | No | any | Allowed values: abuse_trademark |
...
| `trademark_number` | Yes | string | Text not exceeding 1000 characters |
| `trademark_office` | Yes | string | Text not exceeding 1000 characters |
| `trademark_symbol` | Yes | string | Text not exceeding 1000 characters |