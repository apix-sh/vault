...
| `optimize_wordpress` | No | [bot-management_optimize_wordpress](bot-management_optimize_wordpress.md) |  |
| `sbfm_definitely_automated` | No | [bot-management_sbfm_definitely_automated](bot-management_sbfm_definitely_automated.md) |  |
| `sbfm_static_resource_protection` | No | [bot-management_sbfm_static_resource_protection](bot-management_sbfm_static_resource_protection.md) |  |
| `sbfm_verified_bots` | No | [bot-management_sbfm_verified_bots](bot-management_sbfm_verified_bots.md) |  |
