...
| `entries` | No | array<[dlp_ProfileEntryUpdate](./dlp_ProfileEntryUpdate.md)> | Custom entries from this profile.<br/>If this field is omitted, entries owned by this profile will not be changed. |
| `name` | Yes | string |  |
