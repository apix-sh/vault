...
| `reference_id` | Yes | string | A reference ID defined by the client.<br/>Should be set to the Access-Okta IDP integration ID.<br/>Useful when the risk-score integration needs to be associated with a secondary asset and recalled using that ID. |
