...
| `content` | No | string | Formatted CAA content. See 'data' to set CAA properties. |
| `data` | No | object | Components of a CAA record. |
| `type` | No | string | Record type. Allowed values: CAA |