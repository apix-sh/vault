...
| `content` | No | string | Formatted CERT content. See 'data' to set CERT properties. |
| `data` | No | object | Components of a CERT record. |
| `type` | No | string | Record type. Allowed values: CERT |