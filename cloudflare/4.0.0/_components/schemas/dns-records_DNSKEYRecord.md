...
| `content` | No | string | Formatted DNSKEY content. See 'data' to set DNSKEY properties. |
| `data` | No | object | Components of a DNSKEY record. |
| `type` | No | string | Record type. Allowed values: DNSKEY |