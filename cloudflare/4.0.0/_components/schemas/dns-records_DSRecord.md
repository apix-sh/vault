...
| `content` | No | string | Formatted DS content. See 'data' to set DS properties. |
| `data` | No | object | Components of a DS record. |
| `type` | No | string | Record type. Allowed values: DS |