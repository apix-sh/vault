...
| `content` | No | string | Formatted HTTPS content. See 'data' to set HTTPS properties. |
| `data` | No | object | Components of a HTTPS record. |
| `type` | No | string | Record type. Allowed values: HTTPS |