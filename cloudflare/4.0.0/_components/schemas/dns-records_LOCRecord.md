...
| `content` | No | string | Formatted LOC content. See 'data' to set LOC properties. |
| `data` | No | object | Components of a LOC record. |
| `type` | No | string | Record type. Allowed values: LOC |