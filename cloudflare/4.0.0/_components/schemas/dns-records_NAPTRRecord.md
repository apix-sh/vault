...
| `content` | No | string | Formatted NAPTR content. See 'data' to set NAPTR properties. |
| `data` | No | object | Components of a NAPTR record. |
| `type` | No | string | Record type. Allowed values: NAPTR |