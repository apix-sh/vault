...
| `content` | No | string | Formatted SSHFP content. See 'data' to set SSHFP properties. |
| `data` | No | object | Components of a SSHFP record. |
| `type` | No | string | Record type. Allowed values: SSHFP |