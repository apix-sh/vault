...
| `content` | No | string | Formatted SVCB content. See 'data' to set SVCB properties. |
| `data` | No | object | Components of a SVCB record. |
| `type` | No | string | Record type. Allowed values: SVCB |