...
| :------- | :------: | :--- | :---------- |
| `caching` | No | [hyperdrive_hyperdrive-caching](hyperdrive_hyperdrive-caching.md) |  |
| `created_on` | No | string | Defines the creation time of the Hyperdrive configuration. |
| `id` | Yes | [hyperdrive_identifier](hyperdrive_identifier.md) |  |
