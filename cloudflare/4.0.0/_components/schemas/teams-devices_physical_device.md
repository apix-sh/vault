...
| `last_seen_registration` | No | allOf(1) | The last seen registration for the device. |
| `last_seen_user` | No | allOf(1) | The last user to use the WARP device. |
...
| `public_ip` | No | string | **Deprecated**: IP information is provided by DEX - see https://developers.cloudflare.com/api/resources/zero_trust/subresources/dex/subresources/fleet_status/subresources/devices/methods/list/<br/> |
