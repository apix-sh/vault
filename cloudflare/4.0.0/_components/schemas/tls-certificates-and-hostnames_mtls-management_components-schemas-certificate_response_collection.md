...
| `result` | No | array<[tls-certificates-and-hostnames_components-schemas-certificateObject](./tls-certificates-and-hostnames_components-schemas-certificateObject.md)> |  |
| `result_info` | No | object |  |