...
| `id` | No | any | ID of the zone setting. Allowed values: automatic_https_rewrites |
| `value` | No | [zones_automatic_https_rewrites_value](zones_automatic_https_rewrites_value.md) |  |