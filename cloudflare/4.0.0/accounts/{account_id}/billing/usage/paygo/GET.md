...
| `last_year_period_start` | No | integer | Specifies the year of the billing period to query (e.g., 2025). Must be provided together with last_month_period_start. Mutually exclusive with from/to. |
| `last_month_period_start` | No | integer | Specifies the month of the billing period to query (1-12). Must be provided together with last_year_period_start. Mutually exclusive with from/to. |
