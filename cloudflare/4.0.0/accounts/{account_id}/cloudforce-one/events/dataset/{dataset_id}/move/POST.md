...
| Name | Required | Type | Description |
| :--- | :------: | :--- | :---------- |
| `keepRawData` | No | boolean | If true, copies raw data to the destination dataset. Default is false (raw data is stripped/not copied). Raw data is always deleted from the source. |
