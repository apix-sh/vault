---
method: "POST"
url: "https://api.cloudflare.com/client/v4/accounts/{account_id}/devices/registrations/unrevoke"
auth: "bearer"
...
| Name | Required | Type | Description |
| :--- | :------: | :--- | :---------- |
| `id` | Yes | array<string> | A list of registration IDs to unrevoke.<br/>*Serialization: style=Form* |
