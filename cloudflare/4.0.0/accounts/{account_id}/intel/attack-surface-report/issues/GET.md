---
method: "GET"
url: "https://api.cloudflare.com/client/v4/accounts/{account_id}/intel/attack-surface-report/issues"
...
| `page` | No | allOf(1) | *Serialization: style=Form* |
| `per_page` | No | allOf(1) | *Serialization: style=Form* |
