---
method: "POST"
url: "https://api.cloudflare.com/client/v4/accounts/{account_id}/realtime/kit/{app_id}/meetings/{meeting_id}/active-livestream/stop"
auth: "bearer"
...
| `meeting_id` | Yes | string | ID of the meeting |
...
Request body present but no media type entries
