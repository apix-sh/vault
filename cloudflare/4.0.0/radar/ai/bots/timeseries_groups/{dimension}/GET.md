---
method: "GET"
url: "https://api.cloudflare.com/client/v4/radar/ai/bots/timeseries_groups/{dimension}"
...
| `crawlPurpose` | No | array<string> | Filters results by bot crawl purpose. |
| `userAgent` | No | array<string> | Filters results by user agent. |
| `industry` | No | array<string> | Filters results by industry. |
| `vertical` | No | array<string> | Filters results by vertical. |
| `contentType` | No | array<string> | Filters results by content type category. |
