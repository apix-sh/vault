---
method: "GET"
url: "https://api.cloudflare.com/client/v4/radar/as112/top/locations/dnssec/{dnssec}"
...
| :--- | :------: | :--- | :---------- |
| `dnssec` | Yes | string | DNSSEC (DNS Security Extensions) status.<br/>*Serialization: style=Simple* |
