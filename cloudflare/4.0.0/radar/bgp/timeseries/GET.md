---
method: "GET"
url: "https://api.cloudflare.com/client/v4/radar/bgp/timeseries"
...
| `prefix` | No | array<string> | Filters results by BGP network prefix. |
| `updateType` | No | array<string> | Filters results by BGP update type. |
