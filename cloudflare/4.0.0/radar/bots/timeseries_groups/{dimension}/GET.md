...
| `bot` | No | array<string> | Filters results by bot name. |
| `botOperator` | No | array<string> | Filters results by bot operator. |
| `botCategory` | No | array<string> | Filters results by bot category. |
| `botKind` | No | array<string> | Filters results by bot kind. |
| `botVerificationStatus` | No | array<string> | Filters results by bot verification status (Verified vs. Unverified). |
