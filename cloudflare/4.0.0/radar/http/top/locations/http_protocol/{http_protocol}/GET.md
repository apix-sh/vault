---
method: "GET"
url: "https://api.cloudflare.com/client/v4/radar/http/top/locations/http_protocol/{http_protocol}"
...
| :--- | :------: | :--- | :---------- |
| `http_protocol` | Yes | string | HTTP protocol (HTTP vs. HTTPS).<br/>*Serialization: style=Simple* |
