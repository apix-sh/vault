...
| `compromised` | No | array<string> | Filters results by compromised credential status (clean vs. compromised). |
| `checkResult` | No | array<string> | Filters results by leaked credential check result. |
