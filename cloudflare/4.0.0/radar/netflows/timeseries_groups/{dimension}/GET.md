...
| :--- | :------: | :--- | :---------- |
| `dimension` | Yes | string | Specifies the NetFlows attribute by which to group the results. |
...
| `product` | No | array<string> | Filters the results by network traffic product types. |
