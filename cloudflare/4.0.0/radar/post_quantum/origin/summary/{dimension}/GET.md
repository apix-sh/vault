---
method: "GET"
url: "https://api.cloudflare.com/client/v4/radar/post_quantum/origin/summary/{dimension}"
...
| :--- | :------: | :--- | :---------- |
| `dimension` | Yes | string | Specifies the origin post-quantum data dimension by which to group the results. |
