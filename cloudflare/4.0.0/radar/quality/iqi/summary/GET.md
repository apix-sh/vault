---
method: "GET"
url: "https://api.cloudflare.com/client/v4/radar/quality/iqi/summary"
...
| `metric` | Yes | string | Defines which metric to return (bandwidth, latency, or DNS response time).<br/>*Serialization: style=Form* |
