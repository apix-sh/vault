...
| `secret_token` | No | [type_:McpServerConfigOutputSecretToken](type_:McpServerConfigOutputSecretToken.md) |  |
...
| `url` | Yes | [type_:McpServerConfigOutputUrl](type_:McpServerConfigOutputUrl.md) |  |