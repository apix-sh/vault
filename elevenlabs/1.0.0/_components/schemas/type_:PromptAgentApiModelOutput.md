...
| :------- | :------: | :--- | :---------- |
| `backup_llm_config` | No | [type_:PromptAgentApiModelOutputBackupLlmConfig](type_:PromptAgentApiModelOutputBackupLlmConfig.md) |  |
| `built_in_tools` | No | [type_:BuiltInToolsOutput](type_:BuiltInToolsOutput.md) |  |
...
| `rag` | No | [type_:RagConfig](type_:RagConfig.md) |  |
...
| `tools` | No | array<[type_:PromptAgentApiModelOutputToolsItem](./type_:PromptAgentApiModelOutputToolsItem.md)> | A list of tools that the agent can use over the course of the conversation, use tool_ids instead |