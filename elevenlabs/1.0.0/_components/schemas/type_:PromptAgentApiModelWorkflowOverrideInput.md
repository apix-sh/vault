...
| :------- | :------: | :--- | :---------- |
| `backup_llm_config` | No | [type_:PromptAgentApiModelWorkflowOverrideInputBackupLlmConfig](type_:PromptAgentApiModelWorkflowOverrideInputBackupLlmConfig.md) |  |
| `built_in_tools` | No | [type_:BuiltInToolsWorkflowOverrideInput](type_:BuiltInToolsWorkflowOverrideInput.md) |  |
...
| `tools` | No | array<[type_:PromptAgentApiModelWorkflowOverrideInputToolsItem](./type_:PromptAgentApiModelWorkflowOverrideInputToolsItem.md)> | A list of tools that the agent can use over the course of the conversation, use tool_ids instead |