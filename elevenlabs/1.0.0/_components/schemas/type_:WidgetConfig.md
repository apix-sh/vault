...
| `avatar` | No | [type_:WidgetConfigOutputAvatar](type_:WidgetConfigOutputAvatar.md) |  |
...
| `custom_avatar_path` | No | string | The custom avatar path |
...
| `language_selector` | No | boolean | Whether to show the language selector |
...
| `supports_text_only` | No | boolean | Whether the widget can switch to text only mode |
| `syntax_highlight_theme` | No | [type_:WidgetConfigOutputSyntaxHighlightTheme](type_:WidgetConfigOutputSyntaxHighlightTheme.md) |  |
