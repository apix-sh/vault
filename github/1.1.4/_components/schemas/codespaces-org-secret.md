...
| `updated_at` | Yes | string | The date and time at which the secret was created, in ISO 8601 format':' YYYY-MM-DDTHH:MM:SSZ. |
...
| `selected_repositories_url` | No | string | The API URL at which the list of repositories this secret is visible to can be retrieved |