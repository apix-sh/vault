...
| `state` | Yes | string | The current state of the discussion.<br/>`converting` means that the discussion is being converted from an issue.<br/>`transferring` means that the discussion is being transferred from another repository. Allowed values: open, closed, locked, converting, transferring |
