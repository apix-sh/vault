...
| :------- | :------: | :--- | :---------- |
| `advanced_security` | No | object | Enable or disable GitHub Advanced Security for the repository.<br/><br/>For standalone Code Scanning or Secret Protection products, this parameter cannot be used.<br/> |
