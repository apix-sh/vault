...
| `collab` | No | boolean | *Serialization: style=Form* |
| `orgs` | No | boolean | *Serialization: style=Form* |
| `owned` | No | boolean | *Serialization: style=Form* |
| `pulls` | No | boolean | *Serialization: style=Form* |
