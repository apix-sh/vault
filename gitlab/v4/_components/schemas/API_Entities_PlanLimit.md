...
| `enforcement_limit` | No | integer |  |
| `generic_packages_max_file_size` | No | integer |  |
| `helm_max_file_size` | No | integer |  |
| `limits_history` | No | object |  |
| `maven_max_file_size` | No | integer |  |
| `notification_limit` | No | integer |  |
| `npm_max_file_size` | No | integer |  |
