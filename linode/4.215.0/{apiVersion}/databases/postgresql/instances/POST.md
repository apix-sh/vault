...
| `fork` | No | object | Include this object to restore a Managed Database by forking from a backup.<br/><br/>- If you include this object, all other fields are optional.<br/><br/>- Don't include this object if you're creating a new Managed Database. |
...
| `ssl_connection` | No | boolean | Currently required to be `true`. Whether to require SSL credentials to establish a connection to the Managed Database.<br/><br/>Run the [Get managed PostgreSQL database credentials](https://techdocs.akamai.com/linode-api/reference/get-databases-postgre-sql-instance-credentials) operation for access information. |
