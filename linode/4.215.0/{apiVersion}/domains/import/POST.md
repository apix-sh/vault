---
method: "POST"
url: "https://api.linode.com/{apiVersion}/domains/import"
auth: "bearer | oauth2"
...
| :--- | :---: | :--- | :--- |
| `domain` | Yes | string | The domain to import. |
| `remote_nameserver` | Yes | string | The remote nameserver that allows zone transfers (AXFR). |
