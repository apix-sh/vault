...
| :--- | :---: | :--- | :--- |
| `cloud_init` | No | boolean | Whether this image supports [cloud-init](https://www.linode.com/docs/guides/write-files-with-cloud-init/). |
| `description` | No | string | A detailed description of this image. |
| `disk_id` | Yes | integer | The ID of the target Linode disk for this image. |
| `label` | No | string | The short title for this image. If not provided, the disk's current label is used. |
| `tags` | No | array<string> | Tags used for organizational purposes. A tag can be from 3 to 100 characters long, and an image can have a maximum of 500 total tags. |
