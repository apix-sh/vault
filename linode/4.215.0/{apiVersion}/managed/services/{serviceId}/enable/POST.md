---
method: "POST"
url: "https://api.linode.com/{apiVersion}/managed/services/{serviceId}/enable"
auth: "bearer | oauth2"
...
| `serviceId` | Yes | integer | The ID of the Managed Service to enable.<br/>*Serialization: style=Simple* |
