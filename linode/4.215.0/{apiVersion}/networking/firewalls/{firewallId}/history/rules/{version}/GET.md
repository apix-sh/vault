---
method: "GET"
url: "https://api.linode.com/{apiVersion}/networking/firewalls/{firewallId}/history/rules/{version}"
auth: "bearer | oauth2"
...
| `version` | Yes | integer | The firewall rule version to view.<br/>*Serialization: style=Simple* |
