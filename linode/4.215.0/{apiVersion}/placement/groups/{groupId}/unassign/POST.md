---
method: "POST"
url: "https://api.linode.com/{apiVersion}/placement/groups/{groupId}/unassign"
auth: "bearer | oauth2"
...
| :--- | :---: | :--- | :--- |
| `linodes` | No | array<integer> | The `linodeId` values for individual compute instances included in the placement group. |
