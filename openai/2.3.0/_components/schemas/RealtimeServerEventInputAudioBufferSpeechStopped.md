...
| :------- | :------: | :--- | :---------- |
| `audio_end_ms` | Yes | integer | Milliseconds since the session started when speech stopped. This will <br/>correspond to the end of audio sent to the model, and thus includes the <br/>`min_silence_duration_ms` configured in the Session.<br/> |
