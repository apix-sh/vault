...
| :--- | :------: | :--- | :---------- |
| `thread_id` | Yes | string | The ID of the [thread](/docs/api-reference/threads) the messages belong to. |
...
| `run_id` | No | string | Filter messages by the run ID that generated them.<br/> |
