---
method: "PUT"
url: "https://api.planetscale.com/v1/organizations/{organization}/databases/{database}/deploy-requests/{number}/auto-delete-branch"
...
| :--- | :---: | :--- | :--- |
| `enable` | No | boolean | Whether or not to enable auto-delete branch for the deploy request |
