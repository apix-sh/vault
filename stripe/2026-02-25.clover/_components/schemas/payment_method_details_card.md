...
| `installments` | No | anyOf(1) | Installment details for this payment.<br/><br/>For more information, see the [installments integration guide](https://docs.stripe.com/payments/installments). |
