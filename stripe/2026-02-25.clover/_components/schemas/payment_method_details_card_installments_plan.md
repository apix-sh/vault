...
| `interval` | No | string | For `fixed_count` installment plans, this is the interval between installment payments your customer will make to their credit card.<br/>One of `month`. Allowed values: month |
