...
| `verified_name` | No | string | Owner's verified full name. Values are verified or provided by Przelewy24 directly<br/>(if supported) at the time of authorization or settlement. They cannot be set or mutated.<br/>Przelewy24 rarely provides this information so the attribute is usually empty. |