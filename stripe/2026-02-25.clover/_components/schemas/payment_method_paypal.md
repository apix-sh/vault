...
| `payer_email` | No | string | Owner's email. Values are provided by PayPal directly<br/>(if supported) at the time of authorization or settlement. They cannot be set or mutated. |
