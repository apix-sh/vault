...
| `affirm` | No | [payment_method_details_payment_record_affirm](payment_method_details_payment_record_affirm.md) |  |
| `afterpay_clearpay` | No | [payment_method_details_payment_record_afterpay_clearpay](payment_method_details_payment_record_afterpay_clearpay.md) |  |
...
| `bancontact` | No | [payment_method_details_payment_record_bancontact](payment_method_details_payment_record_bancontact.md) |  |
| `billie` | No | [payment_method_details_billie](payment_method_details_billie.md) |  |
| `billing_details` | No | anyOf(1) | The billing details associated with the method of payment. |
| `blik` | No | [payment_method_details_blik](payment_method_details_blik.md) |  |
| `boleto` | No | [payment_method_details_payment_record_boleto](payment_method_details_payment_record_boleto.md) |  |
| `card` | No | [payments_primitives_payment_records_resource_payment_method_card_details](payments_primitives_payment_records_resource_payment_method_card_details.md) |  |
| `card_present` | No | [payment_method_details_card_present](payment_method_details_card_present.md) |  |
| `cashapp` | No | [payment_method_details_payment_record_cashapp](payment_method_details_payment_record_cashapp.md) |  |
| `crypto` | No | [payment_method_details_crypto](payment_method_details_crypto.md) |  |
| `custom` | No | [payments_primitives_payment_records_resource_payment_method_custom_details](payments_primitives_payment_records_resource_payment_method_custom_details.md) |  |
...
| `giropay` | No | [payment_method_details_payment_record_giropay](payment_method_details_payment_record_giropay.md) |  |
...
| `kakao_pay` | No | [payment_method_details_payment_record_kakao_pay](payment_method_details_payment_record_kakao_pay.md) |  |
| `klarna` | No | [payment_method_details_klarna](payment_method_details_klarna.md) |  |
| `konbini` | No | [payment_method_details_payment_record_konbini](payment_method_details_payment_record_konbini.md) |  |
...
| `mb_way` | No | [payment_method_details_payment_record_mb_way](payment_method_details_payment_record_mb_way.md) |  |
| `mobilepay` | No | [payment_method_details_mobilepay](payment_method_details_mobilepay.md) |  |
| `multibanco` | No | [payment_method_details_payment_record_multibanco](payment_method_details_payment_record_multibanco.md) |  |
| `naver_pay` | No | [payment_method_details_payment_record_naver_pay](payment_method_details_payment_record_naver_pay.md) |  |
| `nz_bank_account` | No | [payment_method_details_nz_bank_account](payment_method_details_nz_bank_account.md) |  |
| `oxxo` | No | [payment_method_details_payment_record_oxxo](payment_method_details_payment_record_oxxo.md) |  |
...
| `payment_method` | No | string | ID of the Stripe PaymentMethod used to make this payment. |
| `paynow` | No | [payment_method_details_payment_record_paynow](payment_method_details_payment_record_paynow.md) |  |
...
| `promptpay` | No | [payment_method_details_payment_record_promptpay](payment_method_details_payment_record_promptpay.md) |  |
...
| `us_bank_account` | No | [payment_method_details_payment_record_us_bank_account](payment_method_details_payment_record_us_bank_account.md) |  |
| `wechat` | No | [payment_method_details_wechat](payment_method_details_wechat.md) |  |
| `wechat_pay` | No | [payment_method_details_payment_record_wechat_pay](payment_method_details_payment_record_wechat_pay.md) |  |
| `zip` | No | [payment_method_details_payment_record_zip](payment_method_details_payment_record_zip.md) |  |