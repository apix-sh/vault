...
| :------- | :------: | :--- | :---------- |
| `enabled` | Yes | boolean | If `true`, a shareable `url` will be generated that will take your customers to a hosted login page for the customer portal.<br/><br/>If `false`, the previously generated `url`, if any, will be deactivated. |
