...
| `object` | No | string | Filter external accounts according to a particular object type.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<anyOf(2)> | The list contains all external accounts that have been attached to the Stripe account. These may be bank accounts or cards. |
