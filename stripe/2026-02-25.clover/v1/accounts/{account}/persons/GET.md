...
| `relationship` | No | object | Filters on the list of people returned based on the person's relationship to the account's company.<br/>*Serialization: style=DeepObject, explode=true* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[person](../../../../_components/schemas/person.md)> |  |
