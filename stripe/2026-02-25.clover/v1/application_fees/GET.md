...
| :--- | :------: | :--- | :---------- |
| `charge` | No | string | Only return application fees for the charge specified by this charge ID.<br/>*Serialization: style=Form* |
| `created` | No | anyOf(2) | Only return applications fees that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[application_fee](../../_components/schemas/application_fee.md)> |  |
