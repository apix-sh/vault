...
| :--- | :------: | :--- | :---------- |
| `alert_type` | No | string | Filter results to only include this type of alert.<br/>*Serialization: style=Form* |
...
| `meter` | No | string | Filter results to only include alerts with the given meter.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[billing.alert](../../../_components/schemas/billing.alert.md)> |  |
