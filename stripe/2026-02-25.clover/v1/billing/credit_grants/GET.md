...
| :--- | :------: | :--- | :---------- |
| `customer` | No | string | Only return credit grants for this customer.<br/>*Serialization: style=Form* |
| `customer_account` | No | string | Only return credit grants for this account representing the customer.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[billing.credit_grant](../../../_components/schemas/billing.credit_grant.md)> |  |
