...
| `status` | No | string | Filter results to only include meters with the given status.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[billing.meter](../../../_components/schemas/billing.meter.md)> |  |
