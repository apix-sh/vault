...
| :--- | :------: | :--- | :---------- |
| `active` | No | boolean | Only return configurations that are active or inactive (e.g., pass `true` to only list active configurations).<br/>*Serialization: style=Form* |
...
| `is_default` | No | boolean | Only return the default or non-default configurations (e.g., pass `true` to only list the default configuration).<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[billing_portal.configuration](../../../_components/schemas/billing_portal.configuration.md)> |  |
