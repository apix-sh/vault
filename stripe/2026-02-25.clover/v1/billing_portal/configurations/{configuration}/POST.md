...
| :--- | :---: | :--- | :--- |
| `active` | No | boolean | Whether the configuration is active and can be used to create portal sessions. |
...
| `features` | No | object | Information about the features available in the portal. |
