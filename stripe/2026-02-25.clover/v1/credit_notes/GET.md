...
| :--- | :------: | :--- | :---------- |
| `created` | No | anyOf(2) | Only return credit notes that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
| `customer` | No | string | Only return credit notes for the customer specified by this customer ID.<br/>*Serialization: style=Form* |
| `customer_account` | No | string | Only return credit notes for the account representing the customer specified by this account ID.<br/>*Serialization: style=Form* |
...
| `invoice` | No | string | Only return credit notes for the invoice specified by this invoice ID.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[credit_note](../../_components/schemas/credit_note.md)> |  |
