...
| Name | Required | Type | Description |
| :--- | :------: | :--- | :---------- |
| `created` | No | anyOf(2) | Only return customer balance transactions that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
...
| `invoice` | No | string | Only return transactions that are related to the specified invoice.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[customer_balance_transaction](../../../../_components/schemas/customer_balance_transaction.md)> | Details about each object. |
