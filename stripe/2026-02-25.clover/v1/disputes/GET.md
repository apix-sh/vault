...
| :--- | :------: | :--- | :---------- |
| `charge` | No | string | Only return disputes associated to the charge specified by this charge ID.<br/>*Serialization: style=Form* |
| `created` | No | anyOf(2) | Only return disputes that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
...
| `payment_intent` | No | string | Only return disputes associated to the PaymentIntent specified by this PaymentIntent ID.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[dispute](../../_components/schemas/dispute.md)> |  |
