...
| :--- | :------: | :--- | :---------- |
| `customer` | Yes | string | The ID of the customer.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[entitlements.active_entitlement](../../../_components/schemas/entitlements.active_entitlement.md)> |  |
