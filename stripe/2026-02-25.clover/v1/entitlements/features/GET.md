...
| :--- | :------: | :--- | :---------- |
| `archived` | No | boolean | If set, filter results to only include features with the given archive status.<br/>*Serialization: style=Form* |
...
| `lookup_key` | No | string | If set, filter results to only include features with the given lookup_key.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[entitlements.feature](../../../_components/schemas/entitlements.feature.md)> |  |
