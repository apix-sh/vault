...
| :--- | :------: | :--- | :---------- |
| `created` | No | anyOf(2) | Only return links that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
...
| `expired` | No | boolean | Filter links by their expiration status. By default, Stripe returns all links.<br/>*Serialization: style=Form* |
| `file` | No | string | Only return links for the given file.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[file_link](../../_components/schemas/file_link.md)> | Details about each object. |
