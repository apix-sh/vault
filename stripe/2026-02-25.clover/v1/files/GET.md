...
| :--- | :------: | :--- | :---------- |
| `created` | No | anyOf(2) | Only return files that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
...
| `purpose` | No | string | Filter queries by the file purpose. If you don't provide a purpose, the queries return unfiltered files.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[file](../../_components/schemas/file.md)> |  |
