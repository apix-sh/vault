...
| `created` | No | anyOf(2) | Only return VerificationSessions that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
...
| `related_customer` | No | string | Customer ID<br/>*Serialization: style=Form* |
| `related_customer_account` | No | string | The ID of the Account representing a customer.<br/>*Serialization: style=Form* |
...
| `status` | No | string | Only return VerificationSessions with this status. [Learn more about the lifecycle of sessions](https://docs.stripe.com/identity/how-sessions-work).<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[identity.verification_session](../../../_components/schemas/identity.verification_session.md)> |  |
