...
| :--- | :------: | :--- | :---------- |
| `created` | No | anyOf(2) | Only return invoice payments that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
...
| `invoice` | No | string | The identifier of the invoice whose payments to return.<br/>*Serialization: style=Form* |
...
| `payment` | No | object | The payment details of the invoice payments to return.<br/>*Serialization: style=DeepObject, explode=true* |
...
| `status` | No | string | The status of the invoice payments to return.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[invoice_payment](../../_components/schemas/invoice_payment.md)> | Details about each object. |
