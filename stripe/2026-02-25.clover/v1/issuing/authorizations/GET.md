...
| :--- | :------: | :--- | :---------- |
| `card` | No | string | Only return authorizations that belong to the given card.<br/>*Serialization: style=Form* |
| `cardholder` | No | string | Only return authorizations that belong to the given cardholder.<br/>*Serialization: style=Form* |
| `created` | No | anyOf(2) | Only return authorizations that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
...
| `status` | No | string | Only return authorizations with the given status. One of `pending`, `closed`, or `reversed`.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[issuing.authorization](../../../_components/schemas/issuing.authorization.md)> |  |
