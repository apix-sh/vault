...
| :--- | :------: | :--- | :---------- |
| `created` | No | anyOf(2) | Only return cardholders that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
| `email` | No | string | Only return cardholders that have the given email address.<br/>*Serialization: style=Form* |
...
| `phone_number` | No | string | Only return cardholders that have the given phone number.<br/>*Serialization: style=Form* |
...
| `status` | No | string | Only return cardholders that have the given status. One of `active`, `inactive`, or `blocked`.<br/>*Serialization: style=Form* |
| `type` | No | string | Only return cardholders that have the given type. One of `individual` or `company`.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[issuing.cardholder](../../../_components/schemas/issuing.cardholder.md)> |  |
