...
| :--- | :------: | :--- | :---------- |
| `created` | No | anyOf(2) | Only return Issuing disputes that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
...
| `status` | No | string | Select Issuing disputes with the given status.<br/>*Serialization: style=Form* |
| `transaction` | No | string | Select the Issuing dispute for the given transaction.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[issuing.dispute](../../../_components/schemas/issuing.dispute.md)> |  |
