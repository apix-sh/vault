...
| `lookup_keys` | No | array<string> | Only return personalization designs with the given lookup keys.<br/>*Serialization: style=DeepObject, explode=true* |
| `preferences` | No | object | Only return personalization designs with the given preferences.<br/>*Serialization: style=DeepObject, explode=true* |
...
| `status` | No | string | Only return personalization designs with the given status.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[issuing.personalization_design](../../../_components/schemas/issuing.personalization_design.md)> |  |
