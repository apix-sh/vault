...
| `status` | No | string | Only return physical bundles with the given status.<br/>*Serialization: style=Form* |
| `type` | No | string | Only return physical bundles with the given type.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[issuing.physical_bundle](../../../_components/schemas/issuing.physical_bundle.md)> |  |
