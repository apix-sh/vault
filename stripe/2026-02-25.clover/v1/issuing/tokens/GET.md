---
method: "GET"
url: "https://api.stripe.com//v1/issuing/tokens"
...
| :--- | :------: | :--- | :---------- |
| `card` | Yes | string | The Issuing card identifier to list tokens for.<br/>*Serialization: style=Form* |
| `created` | No | anyOf(2) | Only return Issuing tokens that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
...
| `status` | No | string | Select Issuing tokens with the given status.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[issuing.token](../../../_components/schemas/issuing.token.md)> |  |
