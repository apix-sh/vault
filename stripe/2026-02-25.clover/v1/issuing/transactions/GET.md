...
| :--- | :------: | :--- | :---------- |
| `card` | No | string | Only return transactions that belong to the given card.<br/>*Serialization: style=Form* |
| `cardholder` | No | string | Only return transactions that belong to the given cardholder.<br/>*Serialization: style=Form* |
...
| `type` | No | string | Only return transactions that have the given type. One of `capture` or `refund`.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[issuing.transaction](../../../_components/schemas/issuing.transaction.md)> |  |
