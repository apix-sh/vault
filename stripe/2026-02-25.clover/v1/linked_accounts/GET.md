...
| :--- | :------: | :--- | :---------- |
| `account_holder` | No | object | If present, only return accounts that belong to the specified account holder. `account_holder[customer]` and `account_holder[account]` are mutually exclusive.<br/>*Serialization: style=DeepObject, explode=true* |
...
| `session` | No | string | If present, only return accounts that were collected as part of the given session.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[financial_connections.account](../../_components/schemas/financial_connections.account.md)> | Details about each object. |
