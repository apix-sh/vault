...
| `ownership` | Yes | string | The ID of the ownership object to fetch owners from.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[financial_connections.account_owner](../../../../_components/schemas/financial_connections.account_owner.md)> | Details about each object. |
