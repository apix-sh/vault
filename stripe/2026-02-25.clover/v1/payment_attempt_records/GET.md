---
method: "GET"
url: "https://api.stripe.com//v1/payment_attempt_records"
...
| `payment_record` | Yes | string | The ID of the Payment Record.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[payment_attempt_record](../../_components/schemas/payment_attempt_record.md)> |  |
