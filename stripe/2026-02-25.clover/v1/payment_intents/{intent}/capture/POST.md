...
| `transfer_data` | No | object | The parameters that you can use to automatically create a transfer after the payment<br/>is captured. Learn more about the [use case for connected accounts](https://docs.stripe.com/payments/connected-accounts). |
