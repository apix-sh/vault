...
| :--- | :------: | :--- | :---------- |
| `active` | No | boolean | Only return payment links that are active or inactive (e.g., pass `false` to list all inactive payment links).<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[payment_link](../../_components/schemas/payment_link.md)> |  |
