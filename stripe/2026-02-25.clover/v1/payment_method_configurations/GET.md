...
| :--- | :------: | :--- | :---------- |
| `application` | No | anyOf(2) | The Connect application to filter by.<br/>*Serialization: style=DeepObject, explode=true* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[payment_method_configuration](../../_components/schemas/payment_method_configuration.md)> |  |
