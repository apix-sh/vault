...
| :--- | :------: | :--- | :---------- |
| `domain_name` | No | string | The domain name that this payment method domain object represents.<br/>*Serialization: style=Form* |
| `enabled` | No | boolean | Whether this payment method domain is enabled. If the domain is not enabled, payment methods will not appear in Elements or Embedded Checkout<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[payment_method_domain](../../_components/schemas/payment_method_domain.md)> |  |
