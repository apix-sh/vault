---
method: "POST"
url: "https://api.stripe.com//v1/payment_records/{id}/report_payment_attempt_guaranteed"
...
| `guaranteed_at` | Yes | integer | When the reported payment was guaranteed. Measured in seconds since the Unix epoch. |
