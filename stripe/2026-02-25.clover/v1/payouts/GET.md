...
| :--- | :------: | :--- | :---------- |
| `arrival_date` | No | anyOf(2) | Only return payouts that are expected to arrive during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
| `created` | No | anyOf(2) | Only return payouts that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
| `destination` | No | string | The ID of an external account - only return payouts sent to this external account.<br/>*Serialization: style=Form* |
...
| `status` | No | string | Only return payouts that have the given status: `pending`, `paid`, `failed`, or `canceled`.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[payout](../../_components/schemas/payout.md)> |  |
