...
| :--- | :------: | :--- | :---------- |
| `created` | No | anyOf(2) | Only return items that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
...
| `value` | No | string | Return items belonging to the parent list whose value matches the specified value (using an "is like" match).<br/>*Serialization: style=Form* |
| `value_list` | Yes | string | Identifier for the parent value list this item belongs to.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[radar.value_list_item](../../../_components/schemas/radar.value_list_item.md)> |  |
