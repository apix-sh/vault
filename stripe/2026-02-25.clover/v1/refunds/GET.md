...
| :--- | :------: | :--- | :---------- |
| `charge` | No | string | Only return refunds for the charge specified by this charge ID.<br/>*Serialization: style=Form* |
| `created` | No | anyOf(2) | Only return refunds that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
...
| `payment_intent` | No | string | Only return refunds for the PaymentIntent specified by this ID.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[refund](../../_components/schemas/refund.md)> |  |
