...
| :--- | :------: | :--- | :---------- |
| `created` | No | anyOf(2) | Only return Report Runs that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[reporting.report_run](../../../_components/schemas/reporting.report_run.md)> |  |
