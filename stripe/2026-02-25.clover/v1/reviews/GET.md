...
| :--- | :------: | :--- | :---------- |
| `created` | No | anyOf(2) | Only return reviews that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[review](../../_components/schemas/review.md)> |  |
