...
| :--- | :------: | :--- | :---------- |
| `created` | No | anyOf(2) | A filter on the list, based on the object `created` field. The value<br/>can be a string with an integer Unix timestamp or a<br/>dictionary with a number of different query options.<br/>*Serialization: style=DeepObject, explode=true* |
...
| `setup_intent` | Yes | string | Only return SetupAttempts created by the SetupIntent specified by<br/>this ID.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[setup_attempt](../../_components/schemas/setup_attempt.md)> |  |
