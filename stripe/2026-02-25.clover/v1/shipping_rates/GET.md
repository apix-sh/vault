...
| :--- | :------: | :--- | :---------- |
| `active` | No | boolean | Only return shipping rates that are active or inactive.<br/>*Serialization: style=Form* |
...
| `currency` | No | string | Only return shipping rates for the given currency.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[shipping_rate](../../_components/schemas/shipping_rate.md)> |  |
