...
| `subscription` | Yes | string | The ID of the subscription whose items will be retrieved.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[subscription_item](../../_components/schemas/subscription_item.md)> |  |
