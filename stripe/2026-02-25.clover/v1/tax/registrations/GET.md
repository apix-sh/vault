...
| `status` | No | string | The status of the Tax Registration.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[tax.registration](../../../_components/schemas/tax.registration.md)> |  |
