---
method: "GET"
url: "https://api.stripe.com//v1/tax_ids"
...
| `owner` | No | object | The account or customer the tax ID belongs to. Defaults to `owner[type]=self`.<br/>*Serialization: style=DeepObject, explode=true* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[tax_id](../../_components/schemas/tax_id.md)> | Details about each object. |
