...
| `is_account_default` | No | boolean | if present, only return the account default or non-default configurations.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[terminal.configuration](../../../_components/schemas/terminal.configuration.md)> |  |
