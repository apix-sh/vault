...
| :--- | :------: | :--- | :---------- |
| `amount` | No | anyOf(2) | A positive integer representing how much to transfer.<br/>*Serialization: style=DeepObject, explode=true* |
...
| `status` | No | string | Only return top-ups that have the given status. One of `canceled`, `failed`, `pending` or `succeeded`.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[topup](../../_components/schemas/topup.md)> |  |
