...
| :--- | :------: | :--- | :---------- |
| `created` | No | anyOf(2) | Only return transfers that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
| `destination` | No | string | Only return transfers for the destination specified by this account ID.<br/>*Serialization: style=Form* |
...
| `transfer_group` | No | string | Only return transfers with the specified transfer group.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[transfer](../../_components/schemas/transfer.md)> | Details about each object. |
