...
| `received_credit` | No | string | Only return CreditReversals for the ReceivedCredit ID.<br/>*Serialization: style=Form* |
...
| `status` | No | string | Only return CreditReversals for a given status.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[treasury.credit_reversal](../../../_components/schemas/treasury.credit_reversal.md)> | Details about each object. |
