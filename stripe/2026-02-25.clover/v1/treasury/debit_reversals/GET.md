...
| `received_debit` | No | string | Only return DebitReversals for the ReceivedDebit ID.<br/>*Serialization: style=Form* |
| `resolution` | No | string | Only return DebitReversals for a given resolution.<br/>*Serialization: style=Form* |
...
| `status` | No | string | Only return DebitReversals for a given status.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[treasury.debit_reversal](../../../_components/schemas/treasury.debit_reversal.md)> | Details about each object. |
