...
| `status` | No | string | Only return InboundTransfers that have the given status: `processing`, `succeeded`, `failed` or `canceled`.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[treasury.inbound_transfer](../../../_components/schemas/treasury.inbound_transfer.md)> | Details about each object. |
