...
| :--- | :------: | :--- | :---------- |
| `created` | No | anyOf(2) | Only return OutboundPayments that were created during the given date interval.<br/>*Serialization: style=DeepObject, explode=true* |
| `customer` | No | string | Only return OutboundPayments sent to this customer.<br/>*Serialization: style=Form* |
...
| `status` | No | string | Only return OutboundPayments that have the given status: `processing`, `failed`, `posted`, `returned`, or `canceled`.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[treasury.outbound_payment](../../../_components/schemas/treasury.outbound_payment.md)> | Details about each object. |
