...
| `status` | No | string | Only return OutboundTransfers that have the given status: `processing`, `canceled`, `failed`, `posted`, or `returned`.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[treasury.outbound_transfer](../../../_components/schemas/treasury.outbound_transfer.md)> | Details about each object. |
