...
| `financial_account` | Yes | string | The FinancialAccount that received the funds.<br/>*Serialization: style=Form* |
...
| `linked_flows` | No | object | Only return ReceivedCredits described by the flow.<br/>*Serialization: style=DeepObject, explode=true* |
...
| `status` | No | string | Only return ReceivedCredits that have the given status: `succeeded` or `failed`.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[treasury.received_credit](../../../_components/schemas/treasury.received_credit.md)> | Details about each object. |
