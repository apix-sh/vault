...
| `financial_account` | Yes | string | The FinancialAccount that funds were pulled from.<br/>*Serialization: style=Form* |
...
| `status` | No | string | Only return ReceivedDebits that have the given status: `succeeded` or `failed`.<br/>*Serialization: style=Form* |
...
| :--- | :---: | :--- | :--- |
| `data` | Yes | array<[treasury.received_debit](../../../_components/schemas/treasury.received_debit.md)> | Details about each object. |
