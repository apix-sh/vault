...
| :--- | :------: | :--- | :---------- |
| `AccountSid` | Yes | string | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the DependentPhoneNumber resources to read. |
| `AddressSid` | Yes | string | The SID of the Address resource associated with the phone number. |
...
| :--- | :---: | :--- | :--- |
| `dependent_phone_numbers` | No | array<[api.v2010.account.address.dependent_phone_number](../../../../../../_components/schemas/api.v2010.account.address.dependent_phone_number.md)> |  |
| `end` | No | integer |  |
