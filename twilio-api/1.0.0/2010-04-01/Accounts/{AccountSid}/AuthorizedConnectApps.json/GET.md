...
| :--- | :------: | :--- | :---------- |
| `AccountSid` | Yes | string | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the AuthorizedConnectApp resources to read. |
...
| :--- | :---: | :--- | :--- |
| `authorized_connect_apps` | No | array<[api.v2010.account.authorized_connect_app](../../../../_components/schemas/api.v2010.account.authorized_connect_app.md)> |  |
| `end` | No | integer |  |
