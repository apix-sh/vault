...
| :--- | :------: | :--- | :---------- |
| `AccountSid` | Yes | string | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the ConnectApp resources to read. |
...
| :--- | :---: | :--- | :--- |
| `connect_apps` | No | array<[api.v2010.account.connect_app](../../../../_components/schemas/api.v2010.account.connect_app.md)> |  |
| `end` | No | integer |  |
