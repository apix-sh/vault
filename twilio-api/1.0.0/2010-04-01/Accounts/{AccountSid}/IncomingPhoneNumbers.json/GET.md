...
| :--- | :------: | :--- | :---------- |
| `AccountSid` | Yes | string | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the IncomingPhoneNumber resources to read. |
...
| `FriendlyName` | No | string | A string that identifies the IncomingPhoneNumber resources to read. |
...
| `incoming_phone_numbers` | No | array<[api.v2010.account.incoming_phone_number](../../../../_components/schemas/api.v2010.account.incoming_phone_number.md)> |  |
