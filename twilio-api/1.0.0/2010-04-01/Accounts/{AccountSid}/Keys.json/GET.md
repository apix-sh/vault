...
| :--- | :------: | :--- | :---------- |
| `AccountSid` | Yes | string | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Key resources to read. |
...
| `keys` | No | array<[api.v2010.account.key](../../../../_components/schemas/api.v2010.account.key.md)> |  |
