...
| :--- | :------: | :--- | :---------- |
| `AccountSid` | Yes | string | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Key resources to update. |
| `Sid` | Yes | string | The Twilio-provided string that uniquely identifies the Key resource to update. |
