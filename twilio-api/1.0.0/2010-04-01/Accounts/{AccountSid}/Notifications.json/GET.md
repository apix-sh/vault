...
| :--- | :------: | :--- | :---------- |
| `AccountSid` | Yes | string | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Notification resources to read. |
...
| `notifications` | No | array<[api.v2010.account.notification](../../../../_components/schemas/api.v2010.account.notification.md)> |  |
| `page` | No | integer |  |
