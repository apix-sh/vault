...
| :--- | :------: | :--- | :---------- |
| `AccountSid` | Yes | string | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Queue resources to read. |
...
| `queues` | No | array<[api.v2010.account.queue](../../../../_components/schemas/api.v2010.account.queue.md)> |  |
| `start` | No | integer |  |
| `uri` | No | string |  |
