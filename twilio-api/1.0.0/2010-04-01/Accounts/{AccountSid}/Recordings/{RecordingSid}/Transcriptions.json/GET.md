...
| :--- | :------: | :--- | :---------- |
| `AccountSid` | Yes | string | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Transcription resources to read. |
| `RecordingSid` | Yes | string | The SID of the [Recording](https://www.twilio.com/docs/voice/api/recording) that created the transcriptions to read. |
...
| `start` | No | integer |  |
| `transcriptions` | No | array<[api.v2010.account.recording.recording_transcription](../../../../../../_components/schemas/api.v2010.account.recording.recording_transcription.md)> |  |
| `uri` | No | string |  |
