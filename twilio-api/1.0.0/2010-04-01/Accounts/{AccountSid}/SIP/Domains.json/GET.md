...
| :--- | :------: | :--- | :---------- |
| `AccountSid` | Yes | string | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the SipDomain resources to read. |
...
| :--- | :---: | :--- | :--- |
| `domains` | No | array<[api.v2010.account.sip.sip_domain](../../../../../_components/schemas/api.v2010.account.sip.sip_domain.md)> |  |
| `end` | No | integer |  |
