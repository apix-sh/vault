...
| `DomainSid` | Yes | string | A 34 character string that uniquely identifies the SIP Domain that includes the resource to read. |
...
| :--- | :---: | :--- | :--- |
| `credential_list_mappings` | No | array<[api.v2010.account.sip.sip_domain.sip_credential_list_mapping](../../../../../../../_components/schemas/api.v2010.account.sip.sip_domain.sip_credential_list_mapping.md)> |  |
| `end` | No | integer |  |
