...
| `Sid` | Yes | string | A 34 character string that uniquely identifies the resource to udpate. |
...
| :--- | :---: | :--- | :--- |
| `FriendlyName` | Yes | string | A human readable descriptive text, up to 255 characters long. |
