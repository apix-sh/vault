...
| `address_requirements` | No | [incoming_phone_number_local_enum_address_requirement](incoming_phone_number_local_enum_address_requirement.md) |  |
...
| `emergency_address_status` | No | [incoming_phone_number_local_enum_emergency_address_status](incoming_phone_number_local_enum_emergency_address_status.md) |  |
| `emergency_status` | No | [incoming_phone_number_local_enum_emergency_status](incoming_phone_number_local_enum_emergency_status.md) |  |
...
| `voice_receive_mode` | No | [incoming_phone_number_local_enum_voice_receive_mode](incoming_phone_number_local_enum_voice_receive_mode.md) |  |
| `voice_url` | No | string | The URL we call when this phone number receives a call. The `voice_url` will not be used if a `voice_application_sid` or a `trunk_sid` is set. |