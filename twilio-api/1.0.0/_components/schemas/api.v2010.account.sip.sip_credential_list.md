...
| `friendly_name` | No | string | A human readable descriptive text that describes the CredentialList, up to 64 characters long. |
| `sid` | No | string | A 34 character string that uniquely identifies this resource. |
| `subresource_uris` | No | object | A list of credentials associated with this credential list. |
