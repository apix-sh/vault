...
| :------- | :------: | :--- | :---------- |
| `account_sid` | No | string | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the CredentialListMapping resource. |
...
| `sid` | No | string | The unique string that that we created to identify the CredentialListMapping resource. |