...
| `domain_sid` | No | string | The unique string that is created to identify the SipDomain resource. |
| `friendly_name` | No | string | A human readable descriptive text for this resource, up to 64 characters long. |
